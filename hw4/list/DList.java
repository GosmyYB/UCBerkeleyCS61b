...
public class DList {
  ...
  public void insertFront(Object item) {
    ...
    head.next = newNode(item, head, oldFront);
    oldFront.prev = head.next;
    size++;
  }
  ...
  public void insertBack(Object item) {
    ...
    head.prev = newNode(item, oldBack, head);
    oldBack.next = head.prev;
    size++;
  }
  ...
  public void insertAfter(Object item, DListNode node) {
    ...
    DListNode oldNext = node.next;
    node.next = newNode(item, node, oldNext);
  ...
  public void insertBefore(Object item, DListNode node) {
    ...
    DListNode oldPrev = node.prev;
    node.prev = newNode(item, oldPrev, node);
    oldPrev.next = node.prev;
    size++;
  }
