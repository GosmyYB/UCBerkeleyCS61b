...
public BankApp() {
  ...
  *  @exception IOException if there are problems reading user input.
  *  @exception BadAccountException if deposit to a nonexistent account.
  */
 private void doDeposit() throws IOException, BadAccountException, BadTransactionException {
   ...
   *  @exception IOException if there are problems reading user input.
   *  @exception BadAccountException if withdraw form a nonexistent account.
   */
  private void doWithdraw() throws IOException, BadAccountException, BadTransactionException{
    ...
    ATM.withdraw(acctNumber, amount);// fisrt 
   ...
   *  @exception IOException if there are problems reading user input.
   *  @exception BadAccountException if inquire to a nonexistent account.
   */
